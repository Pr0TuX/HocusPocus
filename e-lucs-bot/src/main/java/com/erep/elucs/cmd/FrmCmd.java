 ...
 * @author dragos
 */
public class FrmCmd extends AbstractCmd {


    public static final String INDUSTRY_TYPE = "frm";
    ...
    public FrmCmd(PircBotX botX) {
        this(botX, "frm", "<country_code> Displays first offers of Food Raw Material from a market specified by <country_code>");
    }

    protected FrmCmd(PircBotX botX, String cmd, String desc) {
        super(botX, cmd, desc);
    ...
    public void doLogic(CommandLine commandLine, MessageEvent event) {
        ...
        if (foods != null) {
            ...
            builder.append(":: ").append(Util.toBold("FRM offers for")).append("(first ").append(TOP_OFFERS).append(")");
